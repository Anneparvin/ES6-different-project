...
const string = `
<h1>my name is ${habib}<h1>
<h2>my job is ${web developer}<h2>
<p>i like to ${drawing}</p>
`
console.log(string);

// ৩.১. শূন্য প্যারামিটার ওয়ালা একটা অ্যারো ফাংশন লিখবে যেটা ৮৯ রিটার্ন করবে। 

const zeroIt = salary =>salary-bonus;
console.log(zeroIt(100,11));
...
const multyLine = (firstLine,secondLine)=> {
    const firstLine = my name is john doe + 7;
    const secondLine = my name is julious der + 7;
...
const number =[89,50,43,49,21].map(number => number/7);
console.log(number);
